    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white px-4">
      ...
      <div className="flex flex-col items-center mb-6">
        ...
        <button
          onClick={handleGoogleSignIn}
          disabled={loading}
          className="w-[400%] max-w-md py-3 bg-red-600 hover:bg-red-700 rounded text-white font-medium transition-colors disabled:bg-red-800 disabled:opacity-70"
        >
      ...
      <form onSubmit={handleEmailSignIn} className="w-full max-w-md space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3 bg-blue-600 hover:bg-blue-700 rounded text-white font-medium transition-colors disabled:bg-blue-800 disabled:opacity-70"
        >
